    ...
    >
      <div className='flex flex-wrap justify-center items-center w-full mb-4'>
        <div className='text-center m-4 mr-12'>
          ...
          <div className='flex justify-center space-x-4 mt-2'>
            ...
            >
              <i className='devicon-github-original colored text-3xl ml-3 dark:invert'></i>
            </a>
            ...
            <a
              ...
              rel='noopener noreferrer'
            >
              <i className='devicon-linkedin-plain colored text-3xl ml-3'></i>
            </a>
            ...
            >
              <img
                ...
                alt='Gmail icon'
                className='h-8 w-8 mx-auto mt-0.5 ml-3'
              />
            </a>
          </div>
      ...
      <div className='grid grid-cols-1 md:grid-cols-3 gap-20 text-justify'>
        <div>
          ...
          <br />
          <i className='devicon-postcss-plain colored text-2xl'></i>{' '}
        ...
        <div>
          ...
          <i className='devicon-express-original colored text-2xl dark:invert'></i>{' '}
          ...
          <br />
          <i className='devicon-mongoose-original colored text-2xl dark:invert'></i>{' '}
        ...
        <div>
          ...
          <i className='devicon-axios-plain colored text-2xl'></i>{' '}
          ...
          <img
            ...
            className='h-6 w-6 inline rounded-full dark:invert'
          />{' '}
